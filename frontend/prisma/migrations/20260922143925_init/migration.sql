...
-- CreateEnum
CREATE TYPE "MovementType" AS ENUM ('PURCHASE', 'ADJUSTMENT', 'RESERVATION', 'RELEASE', 'SALE', 'RETURN', 'CANCEL');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING_PAYMENT', 'PAID', 'PROCESSING', 'PACKED', 'SHIPPED', 'DELIVERED', 'COMPLETED', 'CANCELLED', 'EXPIRED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING_PAYMENT', 'WAITING_VERIFICATION', 'PAID', 'REJECTED', 'EXPIRED');

-- CreateEnum
CREATE TYPE "ConfirmationStatus" AS ENUM ('SUBMITTED', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "ShipmentStatus" AS ENUM ('PENDING', 'PROCESSING', 'SHIPPED', 'IN_TRANSIT', 'DELIVERED');
...
CREATE TABLE "Product" (
    ...
    "careInstruction" TEXT NOT NULL DEFAULT '',
    "shippingReturn" TEXT NOT NULL DEFAULT '',
...
CREATE TABLE "PaymentConfirmation" (
    ...
    "note" TEXT,
    "status" "ConfirmationStatus" NOT NULL DEFAULT 'SUBMITTED',
...
-- CreateIndex
CREATE INDEX "PaymentConfirmation_paymentId_idx" ON "PaymentConfirmation"("paymentId");
